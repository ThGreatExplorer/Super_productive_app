...
function App({ isSignedIn, wallet, productivityApp}) {
  ...
  useEffect(() => {
    console.log(productivityApp.getTasks());
  }, []);
  ...
  return (
    <div>
      <div>
        <DateNavBar setCurrentDate={setCurrentDate} />
        { isSignedIn
        ...
        <CurrentTaskList currentTaskList={currentTaskList} setCurrentTaskList={setCurrentTaskList} currentDate={currentDate}/>
